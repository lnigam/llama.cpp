...
void ggml_cuda_mul_mat_vec_q(
    ...
    // If src1 is pre-quantized Q8_1 (from GGML_OP_RMS_NORM_Q), use directly;
    // otherwise quantize from F32 into a temporary pool buffer.
    ggml_cuda_pool_alloc<char> src1_q8_1_buf;
    const void * src1_q8_1_ptr;
    if (src1->type == GGML_TYPE_Q8_1) {
        GGML_ASSERT(ne10 % MATRIX_ROW_PADDING == 0);
        ...
        quantize_row_q8_1_cuda(src1_d, nullptr, src1_q8_1_buf.get(), src0->type, ne10, s11, s12, s13, ne10_padded, ne11, ne12, ne13, stream);
