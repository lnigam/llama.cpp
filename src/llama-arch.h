...
enum llm_tensor {
    ...
    LLM_TENSOR_SELF_COND_NORM,   // diffusion-gemma4
    LLM_TENSOR_SELF_COND_GATE,   // diffusion-gemma4
    LLM_TENSOR_SELF_COND_UP,     // diffusion-gemma4
    LLM_TENSOR_SELF_COND_DOWN,   // diffusion-gemma4
